...
def _seed_dialogues(conn) -> None:
    ...
    lines += rows(
        "dialogue_shpilkin_repeat",
        [
            (1, "npc", "Вы всё ходите. Значит, капли ещё не взяли.", 0, 10, None, None, None),
    ...
    lines += rows(
        "dialogue_nastasya_repeat",
        [
            (1, "npc", "Вы вернулись. Значит, ещё не назвали вас вслух.", 0, 10, None, None, None),
            (10, "player", "Как пройти туман?", 0, 20, 1, "nastasya_escape", None),
            (11, "player", "Доктор лжёт?", 0, 30, 1, None, None),
            (12, "player", "Мне нельзя спать?", -2, 40, 1, None, None),
            (20, "npc", "Именем. Бумагой. Или правдой, которой стыдно. Иначе вата съест шаг.", 0, -1, None, None, None),
...
def _apply_phase3(conn) -> None:
    ...
    _seed_city_dialogue(
        ...
        [
            (1, "npc", "Ещё раз. Имя или стена.", 0, 10, None, None, None),
            ...
            (30, "npc", "Теперь идите. Мостовая впереди уже не клиника.", -4, -1, None, None, None),
...
def _apply_phase4(conn) -> None:
    ...
    _seed_city_dialogue(
        ...
        [
            (1, "npc", "Карточка открыта. Чернила не высохли.", 0, 10, None, None, None),
            ...
            (20, "npc", "За запертой дверью. Ключ у него. Под ковром — то, чего нет в картотеке.",
             0, -1, None, None, None),
            (30, "npc", "Есть. Туман это любит больше лиц.", -4, -1, None, None, None),
