...
def _seed_dialogues(conn) -> None:
    ...
    lines += rows(
        ...
        [
            ...
            (30, "npc", "Страх — хороший признак, очень хороший. Значит, вы ещё не тень. Тень не боится: тень только ждёт.", -3, -1, None, "spoke_shpilkin", None),
    ...
    lines += rows(
        ...
        [
            ...
            (30, "npc", "Как скажете. Бред тоже умеет убивать. Даже лучше правды: он не спешит.", -5, -1, None, "spoke_nastasya", None),
    ...
    lines += rows(
        ...
        [
            ...
            (16, "player", "Я просил у вас выход. Это долг? Мне нужно слышать это слово.", 0, 53, 1, None, None, "nastasya_escape"),
...
def _apply_phase3(conn) -> None:
    ...
    _seed_city_dialogue(
        ...
        [
            ...
            (20, "npc", "Больных не выпускают. Беглецов — тоже. Выберите, кем быть. Или не выбирайте: вас уже выбрали.", -2, -1, None, "spoke_watchman", None),
    ...
    _seed_city_dialogue(
        ...
        [
            ...
            (30, "npc", "Иванов здесь полно. Туман их не считает. Полно, сударь, полно... и всё-таки мало.", -2, -1, None, "spoke_beggar", None),
...
def _apply_phase17(conn) -> None:
    ...
    _seed_city_dialogue(
        ...
        [
            ...
            (40, "npc", "Жилец? Жильцы ночью спят, не спрашивают ключ. Ключ дома, говорите... дома — в шкафу, да-с, при лавке. А вы — с улицы, в халате. Не верю. Не верю, и счёты со мной.", 0, -1, None, "spoke_lukin", None),
